...
The layout directly implements the patterns from multiple other standards: the layered backend architecture (04) maps to `api/`, `services/`, `repositories/`, `models/`; module structure (05) maps to the `modules/` directory; testing standards (30) map to the hybrid `tests/unit/`, `tests/integration/`, `tests/e2e/` layout; and configuration standards (22) map to `config/` with `.env` and YAML files.
