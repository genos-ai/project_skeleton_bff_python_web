...
Approved cryptographic algorithms, rate limiting thresholds, security headers, and supply chain security rules are defined explicitly because "use appropriate security measures" is not actionable guidance. This document complements authentication (06) for access control, data protection (14) for privacy and PII handling, and observability (08) for security logging and alerting.
