...
| Circuit breaker state | Custom metric (doc 30) | Any breaker open |
| Consumer lag | Custom metric (doc 21) | > 100 events (trading), > 1000 (standard) |
| Thread/process pool utilization | Custom metric (doc 30) | > 90% capacity |
