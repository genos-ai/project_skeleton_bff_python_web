...
The file-based data section (`data/` directory) standardizes how projects handle datasets, exports, and cached artifacts — areas where ad-hoc approaches quickly create sprawling, undocumented file hierarchies. This module connects to module structure (05) through the rule that each module owns its tables, to observability (30) for data pipeline monitoring, and to background tasks (23) for scheduled data processing.
...
See **11-core-project-template.md** for directory structure details.
