...
**Dependencies**: This module requires **22-opt-frontend-architecture.md** (thin client principles) and benefits from **31-ai-agentic-architecture.md** + **32-ai-agentic-pydanticai.md** for agent integration patterns.
...
- [31-ai-agentic-architecture.md](31-ai-agentic-architecture.md) — Agent concepts, human-in-the-loop, cost tracking, reasoning chains
- [32-ai-agentic-pydanticai.md](32-ai-agentic-pydanticai.md) — PydanticAI implementation, API endpoints, event types
